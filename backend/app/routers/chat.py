...
CONTEXT_HINTS = {
    ...
    # ── Physics ────────────────────────────────────────────────────
    "physics":      "Ученик на экране Физики — изучает законы природы, механику, электричество и оптику.",
    "circuits":     "Ученик в игре «Конструктор Цепей» — строит электрическую цепь из батарейки, выключателя, резистора и лампочки. Закон Ома: I = U / R.",
    "trajectory":   "Ученик играет в «Баллистику» — рассчитывает угол и скорость броска ядра. Формула траектории: y = x·tan(θ) − g·x²/(2v²·cos²(θ)).",
    "mechanics":    "Ученик изучает механику и движение — скорость, ускорение, законы Ньютона.",
    "optics":       "Ученик изучает оптику — отражение и преломление света, линзы.",
    "thermodynamics":"Ученик изучает тепловые явления — температуру, теплообмен, агрегатные состояния.",
}
...
def build_system_instruction(screen: str, lang: str) -> str:
    ...
    return (
        ...
        f"- Называешь ученика «юный учёный», «исследователь» или «юный физик» в контексте физики\n"
